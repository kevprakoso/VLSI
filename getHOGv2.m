...
%     end
    ...
    for rr = 1 : (numVerticalCells - 1)
        ...
        for cc = 1 : (numHorizonCells - 1)
            ...
            hist1 = getHistogramv2(dxBlock1(:),dyBlock1(:), numBins, mask(1:8 , 1:8));  %  9 x 1
            hist2 = getHistogramv2(dxBlock2(:),dyBlock2(:), numBins, mask(1:8 , 9:16));  %  9 x 1
            hist3 = getHistogramv2(dxBlock3(:),dyBlock3(:), numBins, mask(9:16, 1:8));  %  9 x 1
            hist4 = getHistogramv2(dxBlock4(:),dyBlock4(:), numBins, mask(9:16, 9:16));  %  9 x 1
